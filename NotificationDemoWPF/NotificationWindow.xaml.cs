...
namespace NotificationDemoWPF
{
    ...
    public partial class NotificationWindow : Window
    {
        ...
        {
            if(this.DataContext is NotifyData data)
            {
            ...
            if (sender is NotificationWindow self)
            {
                ...
                double right = System.Windows.SystemParameters.WorkArea.Right - 10;//工作区最右边的值
        ...
        {
            double right = System.Windows.SystemParameters.WorkArea.Right - 10;
            DoubleAnimation animation = new DoubleAnimation();
            animation.Duration = new Duration(TimeSpan.FromMilliseconds(500));
