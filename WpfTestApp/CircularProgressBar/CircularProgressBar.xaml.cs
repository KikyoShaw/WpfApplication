...
namespace WpfTestApp.CircularProgressBar
{
    /// <summary>
    ...
    public partial class CircularProgressBar : UserControl
    {
        ...
        private void SetValue2(double percentValue)
        {
            double angel = (1 - percentValue) * 360;
            ...
            PathFigure pathFigure = new PathFigure();
            pathFigure.StartPoint = new Point(leftStart, topStart + radius);
            pathFigure.Segments = pathsegmentCollection;
